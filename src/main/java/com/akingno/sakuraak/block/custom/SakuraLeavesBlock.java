...
public class SakuraLeavesBlock extends LeavesBlock {
    ...
    public SakuraLeavesBlock(BlockBehaviour.Properties builder, Supplier<SimpleParticleType> particle) {
        super(builder);
    ...
    @Override
    @OnlyIn(Dist.CLIENT)
    public void animateTick(net.minecraft.world.level.block.state.BlockState stateIn, Level worldIn, BlockPos pos, RandomSource rand) {
